...
class Translations {
    private static $translations = [
        "en" => [
            ...
            "sticker_text" => "<strong>Hey :?:!</strong><br /> Please respond to our invitation <br /><em>latest until 30st of June</em><br> by following the <abbr lang='en' title='Uniform Resource Locator'>URL: :?:</abbr> <br />or by scanning the <abbr lang='en' title='Quick Response'>QR</abbr> code:",
        ],
        "de" => [
