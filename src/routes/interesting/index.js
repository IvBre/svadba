...
const Interesting = () => (
	<div class={style.home}>
		...
		<p>
			Websites to give you an inspiration for which bars or restaurants to try: <br />
			<ul>
			...
			We recommend you to try the taverns, if you want to experience some traditional Serbian night life, <br />
			and "splavovi" - the raft bars/disco if you want more "unusual" party vibe.
		</p>
		<p>
			For more sight seeing we recommend you to do the following things:
			<ul>
				<li>Walk through <a href="http://www.serbia.com/visit-serbia/cultural-attractions/palaces-and-fortresses/belgrade-fortress-follow-the-paths-of-history/" target="_blank">the Belgrade Fortress</a>.</li>
				<li>On the way to the fortress you can go through <a href="https://www.tripadvisor.com/Attraction_Review-g294472-d550326-Reviews-Knez_Mihailova-Belgrade.html" target="_blank">the Knez Mihailova street</a>, which is the "Könnings Alle" of Belgrade. <br />
					Often there will be interesting street performers on the way.</li>
				<li>Have a dinner or drinks at <a href="https://www.tripadvisor.com/Attraction_Review-g294472-d536408-Reviews-Skadarlija-Belgrade.html" target="_blank">Skadarlija - the bohemian street</a>. <br />
					Be aware that it is the most expensive place in all of Belgrade, although still cheaper then luxury restaurants in Germany.</li>
				<li>Visit <a href="https://nikolateslamuseum.org/en/" target="_blank">the Nikola Tesla museum</a>.</li>
				<li>In the near of the museum you can find the <a href="https://en.wikipedia.org/wiki/Church_of_Saint_Sava" target="_blank">St. Sava temple</a> one of the largest Orthodox churches in the world.</li>
				<li>You can plan a whole day at <a href="https://www.adaciganlija.rs/en/" target="_blank">Ada Ciganlija</a> aka "The Belgrade See" where you can have a swim in the lake, enjoy refreshing drinks from the beach bars, <br />
				or if you're a sports/adrenaline fan, have a round of volley ball / skating / cycling / golfing / rowing / bungee jumping etc.</li>
				<li>We would also recommend you to visit the other side of the Belgrade, district called "Zemun", <br />
					especially it's <a href="https://www.tripadvisor.com/Attraction_Review-g1898555-d4945034-Reviews-Zemunski_kej-Zemun_Belgrade.html" target="_blank">old town's promenade</a> by the Danube.</li>
			</ul>
		</p>

		<h2>Banja Koviljača</h2>
		<p>
		...
		<h2>Other parts of the Western Serbia</h2>
		<p>
