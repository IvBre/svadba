...
const Schedule = () => (
	<div class="pageWrapper">
		...
		<ul>
			<li class={style.listItem}><time datetime="13:00+02:00" class={`${style.time} ampersand`}><span class="ampersandArrowLeft"></span>13:00<span class="ampersandArrowRight"></span></time> <span class={style.listItemText}>Cocktail for the guests <span lang="sr">(svatovi)</span> at the top balcony of the Kur-salon.</span></li>
			...
			<li class={style.listItem}><time datetime="15:30+02:00" class={`${style.time} ampersand`}><span class="ampersandArrowLeft"></span>15:30<span class="ampersandArrowRight"></span></time> <span class={style.listItemText}>Going back to the Kur-Salon together with the bride.</span></li>
			...
			<li class={style.listItem}><time datetime="17:00+02:00" class={`${style.time} ampersand`}><span class="ampersandArrowLeft"></span>17:00<span class="ampersandArrowRight"></span></time> <span class={style.listItemText}>Wedding ceremony at the top balcony of the Kur-Salon.</span></li>
