...
const Covid = () => {
    ...
    return (
        <div class="pageWrapper">
            ...
            <p>At the moment of writing this (May 2021), you are allowed to enter the country if you have received a vaccine or a negative PCR test not older then 48 hours.<br />
